...
The engine is designed to be mounted in Rails applications. The main API is the `PromptEngine.render` method defined in `lib/prompt_engine.rb`:
...
**Implemented**: Core CRUD, version control, parameter management, playground, admin UI, evaluation runner
